...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    expect(getCharacter('Arya')).toStrictEqual(expectedArya);
    ...
    expect(getCharacter('Brienne')).toStrictEqual(expectedBrienne);
    ...
    expect(getCharacter('Melissandre')).toStrictEqual(expectedMelissandre);
    expect(getCharacter('MeLiSSanDrE')).toStrictEqual(expectedMelissandre);
